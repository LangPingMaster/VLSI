// Review notes for uploaded ALU(6).sv
// [OK] All 31 required legal operations are present and the provided 2326 CSV vectors pass.
// [RISK-1] CLZ/CTZ/CPOP decoder should also check funct7=0110000 and funct3=001.
// [RISK-2] DSP should explicitly check opcode=0001011 and funct7=0000000.
// [RISK-3] ABS/CLIP8 should check rs2 field = 00000.
// [RISK-4] Some R-type branches use broad 'else' for MULHSU/MULHU/MIN/MAX/MAXU;
//          explicit funct7 checks are safer for illegal encodings.
// [LINT] mul_ss/mul_uu are written in always_comb only on some paths; give defaults.
//
